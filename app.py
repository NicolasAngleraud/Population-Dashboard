...
population_prediction = pd.read_csv('data/forecast/prefecture_population_forecast_2024.csv')
...
predictive_model_results = pd.read_csv("data/forecast/forecast_validation_summary_2024.csv", header=None, index_col=0)
